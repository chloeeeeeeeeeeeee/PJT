    ...
    return (
        ...
        {/* <CardHeader>
            ...
            <CardBody sm="12" className="aboutUsBody">
                ...
                <br/>
                <p className='mb-0 aboutUsText'>
                저희팀은 아동급식카드 아동들에게 제공되는 1회 카드 결제 금액이 6000원 남짓이라는 사실을 듣고, 이 아이들을 도와줄 수 있는 서비스가 무엇인지 고민해보았습니다.
                
                예전에 '미리내'라는 서비스 다들 알고 계시나요? 가게에 누군가를 위한 커피 한 잔을 사두면, 불특정 누군가가 커피를 마실 수 있는 기부 운동, 저희는 거기서 아이디어를 얻어 시작했습니다.
                </p>
                
                <br/>
                <p className='mb-0 aboutUsText'>
                여러분들이 직접 아이들에게 사주고 싶은 한 그릇을 선택해 기본 결제 금액인 6000원 차액을 후원해주세요. 후원은 웹사이트와 아동급식카드 가맹점 내의 키오스크에서 가능합니다.
                
                해당 한 그릇이 아이들에게 제대로 전달되었는지 여부를 알고싶으시다면, 따뜻한 마음으로 함께하기를 클릭해주세요. 당신의 따뜻한 마음이 잘 전달되었는지 마이페이지를 통해 확인하실 수 있습니다.
                </p>
